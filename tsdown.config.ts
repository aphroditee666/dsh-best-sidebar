/**
 * tsdown build for dsh-best-sidebar: the host-half lib (lib/index.js and
...
function chunkBundle(name: string): UserConfig {
  return {
    ...
    plugins: [
      purityGatePlugin(),
      makeCssPlugin('@aphroditee666/dsh-best-sidebar'),
...
export default [
  ...
  clientBundle('@aphroditee666/dsh-best-sidebar', 'client.js'),
  // Plugin-registry channel: bundle id = manifest id (dsh.plugin.json `id`).
  clientBundle('dsh-external/@aphroditee666/dsh-best-sidebar', 'client-registry.js'),
