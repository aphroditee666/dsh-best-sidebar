window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/home/runner/work/DSH-best-sidebar/DSH-best-sidebar/src/client/sidebar.module.css.mjs
		...
		const tagId$4 = "dsh-best-sidebar/sidebar.module.css";
		if (typeof document !== "undefined" && document.querySelector("style[data-plugin-css=" + JSON.stringify(tagId$4) + "]") === null) {
			const tag = document.createElement("style");
			tag.dataset.plugin = "dsh-best-sidebar";
		...
		*/
		...
		const api = {
			...
			*  side panel's search box); matches are cwd-relative '/'-separated paths. */
			...
			/* [dsh-patch] create one directory (non-recursive); wire method fs.createDirectory */
				...
				return (level.entries ?? []).map((entry) => {
					if (entry.isDir) {
						...
						return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
							...
							/* [dsh-patch] folder row draggable: carry the path for the sidebar->composer drop */
							draggable: true,
							onDragStart: (event) => {
					...
					return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						...
						/* [dsh-patch] file row draggable: carry the path for the sidebar->composer drop */
							draggable: true,
							onDragStart: (event) => {
								event.dataTransfer.setData("application/x-dsh-sidebar-path", entry.path);
								event.dataTransfer.setData("text/plain", entry.path);
				...
				children: [
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.Menu, {
						...
						items: [
							...
							...rowMenu?.isDir === true ? [{
								/* [dsh-patch] new folder / new file via right-click on a folder */
								id: "new-folder",
								label: "新建文件夹",
								icon: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.IconFolderOpen16, { size: 14 })
							}, {
						...
						onSelect: (id) => {
							...
							/* [dsh-patch] create folder/file, then refresh the tree */
							if (id === "new-folder" || id === "new-file") {
								...
								const req = isFolder ? api.fsCreateDir({ sessionId, cwd }, child) : api.fsWrite({ sessionId, cwd }, child, "");
								req.then(() => setRefreshTick((tick) => tick + 1)).catch((error) => window.alert((isFolder ? "创建文件夹失败：" : "创建文件失败：") + (error?.message ?? error)));
								return;
							}
		...
		*/
		function TreePanel(props) {
			...
			/* [dsh-patch] silent auto-refresh: poll visible tree levels, re-render only when content changed */
		...
		*/
		...
		var SideChatView_module_css_default = {
			...
			"sidechatToolName": "_4BEzFa_sidechatToolName",
			"sidechatTool": "_4BEzFa_sidechatTool",
			"sidechatToolResult": "_4BEzFa_sidechatToolResult",
			"sidechatReasoningBody": "_4BEzFa_sidechatReasoningBody",
			...
			"sidechatToolArgs": "_4BEzFa_sidechatToolArgs",
			"sidechatToolSummary": "_4BEzFa_sidechatToolSummary",
			"sidechat": "_4BEzFa_sidechat",
			"sidechatComposerBar": "_4BEzFa_sidechatComposerBar",
			"sidechatToolFailed": "_4BEzFa_sidechatToolFailed",
			"sidechatReasoning": "_4BEzFa_sidechatReasoning",
			...
			"sidechatToolExecuting": "_4BEzFa_sidechatToolExecuting",
			"sidechatIconBtn": "_4BEzFa_sidechatIconBtn",
			"sidechatReasoningSummary": "_4BEzFa_sidechatReasoningSummary"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/home/runner/work/DSH-best-sidebar/DSH-best-sidebar/src/client/layout.css.mjs
		...
		const tagId = "dsh-best-sidebar/layout.css";
		...
		*/
		function apply(ctx) {
			...
			/* [dsh-patch] drag a sidebar file onto the conversation composer -> insert @<relative path> into the session draft */
			ctx.effect(() => {
				...
				const onDragover = (event) => {
					try {
						...
						if (dt === null || !dt.types || !Array.from(dt.types).includes(MIME)) return;
				...
				const onDrop = (event) => {
					try {
						...
						event.preventDefault();
						event.stopPropagation();
						const box = target.closest("textarea") ?? null;
						if (box === null) return;
						...
						input.setDraft(next);
						/* restore caret just after the inserted absolute path */
						...
						console.warn("[dsh-best-sidebar] sidebar-to-composer drop failed:", error);
					}
				};
			...
			}, "dsh-best-sidebar: sidebar-to-composer drop");
			ctx.effect(() => {
